    ...
    try:
        ...
        application_document = {
            ...
            "location": {
                ...
                "postCode": str(orchestration_input.get("postCode")) if isinstance(orchestration_input.get("postCode"), int) else orchestration_input.get("postCode"),
            },
    ...
    try:
        ...
        updated_doc_fragment = {
            ...
            "location": {
                ...
                "postCode": str(updated_candidate_data.get("postCode")) if isinstance(updated_candidate_data.get("postCode"), int) else updated_candidate_data.get("postCode"),
            },
            "education": education_data,
